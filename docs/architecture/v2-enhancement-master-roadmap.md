...
> 2. `docs/architecture/stock-insight-e2e-layers.md` — 완성형 V2 레이어 정본 (L0~L8 · X1~X4)
> 3. `docs/architecture/stock-insight-v2-enhancement-plan.md` — V2 고도화 종합 계획 (근거 기반 시장 월드모델, §0~§30 + 부록 A~D)
>
> - 작성일: 2026-07-20 KST
...
> 성능·엣지 관련 실측은 [`docs/architecture/operations/edge-and-login-performance.md`](../../operations/edge-and-login-performance.md).
...
| 항목 | 작업                                                                       |
+------+----------------------------------------------------------------------------+
| P0-1 | 명칭 고정 규칙(§0)을 ADR로 저장: docs/architecture/adr/ADR-001-v2-naming-freeze.md      |
...
전 구간이 성공했다. 상세: [`docs/architecture/operations/analytics-pipeline-outage-2026-08.md`](../../operations/analytics-pipeline-outage-2026-08.md).
