...
// Upstream: https://animate-ui.com/docs/components/buttons/button
// Registry item: @animate-ui/components-buttons-button
...
} from '@/shared/ui/animate-ui/primitives/buttons/button';
